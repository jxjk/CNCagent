...
def test_issue_fix():
    """测试修复后的代码"""
    print("测试修复后的CNC Agent处理极坐标描述问题")
    print("="*60)
    ...
    # 测试G代码生成（使用空特征列表，仅依赖描述）
    print("4. G代码生成测试:")
    try:
        # 创建一个空的特征列表，让系统仅依赖描述分析结果
        empty_features = []
        gcode = generate_fanuc_nc(empty_features, analysis_result)
        print("   G代码生成成功！")
        print("   前20行G代码:")
        lines = gcode.split('\n')
