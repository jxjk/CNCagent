...
# 创建模拟的沉孔特征（不设置直径，让系统从description_analysis中提取）
features = [
    {
        'shape': 'counterbore',
        ...
        # 不设置outer_diameter和inner_diameter，让系统从description_analysis中提取
        'depth': 20.0,  # 沉孔深度20mm
        'contour': [],
...
# 保存生成的NC程序
with open("test_final_output.nc", "w", encoding="utf-8") as f:
    f.write(nc_program)
print("\nNC程序已保存到: test_final_output.nc")